...
public class SetUpPermissionActivity extends AppCompatActivity {
    private static final int MY_PERMISSIONS_REQUEST_SEND_SMS = 0;
    private static final int MY_PERMISSION_REQUEST_SEND_SMS = 0;
    EditText textPhoneNo;
    String textMsg, msg, phoneNo;
    Button send;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_set_up_permission);
//check if the permission is not granted
        ...
        textMsg = "URGENT ASSISTANCE NEEDED! PLEASE HELP IMMEDIATELY!";
